...
const authorId = process.env.authorId // you or some1 else
const guildId = process.env.guildID // which server
const channelId = process.env.channelId // which channel
const minId = process.env.minId // id of message between MIN
const maxId = process.env.maxId // id of message between MAX
const content = process.env.content // words which specificly need to be deleted
const hasLink = process.env.hasLink // set to true or false
const hasFile = process.env.hasFile // set to true or false
const includeNsfw = process.env.includeNsfw // set to true or false
const extLogger = process.env.extLogger // set to true or false
const includePinned = process.env.includePinned // set to true or false
const pattern = process.env.pattern // tbh idk what this does lmao
...
(function () {
     ...
     * idk what I am doing it would be funny if this works tho
     */
    async function deleteMessages(authToken, authorId, guildId, channelId, minId, maxId, content, hasLink, hasFile, includeNsfw, includePinned, pattern, searchDelay, deleteDelay, extLogger, onProgress) {
